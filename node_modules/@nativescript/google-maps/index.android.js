import { Application, Color, Device, GridLayout, ImageSource, Utils, View } from '@nativescript/core';
...
export class Polygon extends OverLayBase {
    ...
    set holes(value) {
        if (Array.isArray(value)) {
            const nativeHoles = new java.util.ArrayList();
            value.forEach((hole) => {
                if (Array.isArray(hole) && hole.length) {
                    const nativeHole = new java.util.ArrayList();
