...
var require_volume = __commonJS({
  "../../node_modules/memfs/lib/volume.js"(exports) {
    ...
    var Volume2 = function() {
      ...
      Volume3.fromJSON = function(json, cwd) {
        var vol = new Volume3();
        vol.fromJSON(json, cwd);
        return vol;
      };
      Volume3.fromNestedJSON = function(json, cwd) {
        var vol = new Volume3();
      ...
      Volume3.prototype.getFileByFd = function(fd) {
        return this.fds[String(fd)];
      };
      Volume3.prototype.getFileByFdOrThrow = function(fd, funcName) {
        if (!isFd(fd))
          throw TypeError(ERRSTR.FD);
      ...
      Volume3.prototype._toJSON = function(link, json, path) {
        var _a2;
        if (link === void 0) {
          link = this.root;
        }
      ...
      Volume3.prototype.fromJSON = function(json, cwd) {
        if (cwd === void 0) {
      ...
      Volume3.prototype.fromNestedJSON = function(json, cwd) {
      ...
      Volume3.prototype.openSync = function(path, flags, mode) {
        if (mode === void 0) {
          mode = 438;
        }
      ...
      Volume3.prototype.open = function(path, flags, a, b) {
        var mode = a;
        var callback = b;
      ...
      Volume3.prototype.closeSync = function(fd) {
        validateFd(fd);
        var file = this.getFileByFdOrThrow(fd, "close");
        this.closeFile(file);
      };
      Volume3.prototype.close = function(fd, callback) {
        validateFd(fd);
      ...
      Volume3.prototype.readBase = function(fd, buffer, offset, length, position) {
        var file = this.getFileByFdOrThrow(fd);
        return file.read(buffer, Number(offset), Number(length), position);
      };
      Volume3.prototype.readSync = function(fd, buffer, offset, length, position) {
        validateFd(fd);
        return this.readBase(fd, buffer, offset, length, position);
      };
      Volume3.prototype.read = function(fd, buffer, offset, length, position, callback) {
        var _this = this;
        validateCallback(callback);
        if (length === 0) {
      ...
      Volume3.prototype.writeBase = function(fd, buf, offset, length, position) {
        var file = this.getFileByFdOrThrow(fd, "write");
        return file.write(buf, offset, length, position);
      };
      Volume3.prototype.writeSync = function(fd, a, b, c, d) {
        validateFd(fd);
        var encoding;
        var offset;
        var length;
      ...
      Volume3.prototype.write = function(fd, a, b, c, d, e) {
        var _this = this;
        validateFd(fd);
        var offset;
        var length;
      ...
      Volume3.prototype.unlinkSync = function(path) {
        var filename = pathToFilename(path);
        this.unlinkBase(filename);
      };
      Volume3.prototype.unlink = function(path, callback) {
        var filename = pathToFilename(path);
      ...
      Volume3.prototype.symlinkSync = function(target, path, type) {
        var targetFilename = pathToFilename(target);
        var pathFilename = pathToFilename(path);
        this.symlinkBase(targetFilename, pathFilename);
      };
      Volume3.prototype.symlink = function(target, path, a, b) {
      ...
      Volume3.prototype.realpathSync = function(path, options) {
        return this.realpathBase(pathToFilename(path), getRealpathOptions(options).encoding);
      };
      Volume3.prototype.realpath = function(path, a, b) {
        var _a2 = getRealpathOptsAndCb(a, b), opts = _a2[0], callback = _a2[1];
        var pathFilename = pathToFilename(path);
        this.wrapAsync(this.realpathBase, [pathFilename, opts.encoding], callback);
      };
      Volume3.prototype.lstatBase = function(filename, bigint, throwIfNoEntry) {
        if (bigint === void 0) {
          bigint = false;
        }
      ...
      Volume3.prototype.lstatSync = function(path, options) {
      ...
      Volume3.prototype.lstat = function(path, a, b) {
      ...
      Volume3.prototype.statBase = function(filename, bigint, throwIfNoEntry) {
        if (bigint === void 0) {
          bigint = false;
        }
        if (throwIfNoEntry === void 0) {
      ...
      Volume3.prototype.statSync = function(path, options) {
      ...
      Volume3.prototype.stat = function(path, a, b) {
      ...
      Volume3.prototype.fstatBase = function(fd, bigint) {
        if (bigint === void 0) {
          bigint = false;
        }
        var file = this.getFileByFd(fd);
      ...
      Volume3.prototype.fstatSync = function(fd, options) {
        return this.fstatBase(fd, getStatOptions(options).bigint);
      };
      Volume3.prototype.fstat = function(fd, a, b) {
      ...
      Volume3.prototype.existsSync = function(path) {
        try {
      ...
      Volume3.prototype.exists = function(path, callback) {
        var _this = this;
        var filename = pathToFilename(path);
        if (typeof callback !== "function")
      ...
      Volume3.prototype.accessSync = function(path, mode) {
        if (mode === void 0) {
          mode = F_OK;
        }
        var filename = pathToFilename(path);
      ...
      Volume3.prototype.access = function(path, a, b) {
        var mode = F_OK;
        var callback;
        if (typeof a !== "function") {
          mode = a | 0;
      ...
      Volume3.prototype.readdirSync = function(path, options) {
        var opts = getReaddirOptions(options);
        var filename = pathToFilename(path);
        return this.readdirBase(filename, opts);
      };
      Volume3.prototype.readdir = function(path, a, b) {
      ...
      Volume3.prototype.readlinkSync = function(path, options) {
        var opts = getDefaultOpts(options);
        var filename = pathToFilename(path);
        return this.readlinkBase(filename, opts.encoding);
      };
      Volume3.prototype.readlink = function(path, a, b) {
        var _a2 = getDefaultOptsAndCb(a, b), opts = _a2[0], callback = _a2[1];
        var filename = pathToFilename(path);
        this.wrapAsync(this.readlinkBase, [filename, opts.encoding], callback);
      };
      Volume3.prototype.fsyncBase = function(fd) {
        this.getFileByFdOrThrow(fd, "fsync");
      };
      Volume3.prototype.fsyncSync = function(fd) {
        this.fsyncBase(fd);
      };
      Volume3.prototype.fsync = function(fd, callback) {
        this.wrapAsync(this.fsyncBase, [fd], callback);
      };
      Volume3.prototype.fdatasyncBase = function(fd) {
        this.getFileByFdOrThrow(fd, "fdatasync");
      };
      Volume3.prototype.fdatasyncSync = function(fd) {
        this.fdatasyncBase(fd);
      };
      Volume3.prototype.fdatasync = function(fd, callback) {
        this.wrapAsync(this.fdatasyncBase, [fd], callback);
      };
      Volume3.prototype.ftruncateBase = function(fd, len) {
        var file = this.getFileByFdOrThrow(fd, "ftruncate");
        file.truncate(len);
      };
      Volume3.prototype.ftruncateSync = function(fd, len) {
        this.ftruncateBase(fd, len);
      };
      Volume3.prototype.ftruncate = function(fd, a, b) {
        var len = typeof a === "number" ? a : 0;
        var callback = validateCallback(typeof a === "number" ? b : a);
        this.wrapAsync(this.ftruncateBase, [fd, len], callback);
      };
      Volume3.prototype.truncateBase = function(path, len) {
      ...
      Volume3.prototype.futimesBase = function(fd, atime, mtime) {
        var file = this.getFileByFdOrThrow(fd, "futimes");
        var node = file.node;
        node.atime = new Date(atime * 1e3);
        node.mtime = new Date(mtime * 1e3);
      };
      Volume3.prototype.futimesSync = function(fd, atime, mtime) {
        this.futimesBase(fd, toUnixTimestamp(atime), toUnixTimestamp(mtime));
      };
      Volume3.prototype.futimes = function(fd, atime, mtime, callback) {
      ...
      Volume3.prototype.utimesSync = function(path, atime, mtime) {
        this.utimesBase(pathToFilename(path), toUnixTimestamp(atime), toUnixTimestamp(mtime));
      };
      Volume3.prototype.utimes = function(path, atime, mtime, callback) {
      ...
      Volume3.prototype.mkdirSync = function(path, options) {
      ...
      Volume3.prototype.mkdir = function(path, a, b) {
      ...
      Volume3.prototype.mkdirpSync = function(path, mode) {
        this.mkdirSync(path, { mode, recursive: true });
      };
      Volume3.prototype.mkdirp = function(path, a, b) {
      ...
      Volume3.prototype.rmdirSync = function(path, options) {
        this.rmdirBase(pathToFilename(path), options);
      };
      Volume3.prototype.rmdir = function(path, a, b) {
        var opts = getRmdirOptions(a);
        var callback = validateCallback(typeof a === "function" ? a : b);
        this.wrapAsync(this.rmdirBase, [pathToFilename(path), opts], callback);
      };
      Volume3.prototype.rmBase = function(filename, options) {
        if (options === void 0) {
          options = {};
        }
        var link = this.getResolvedLink(filename);
      ...
      Volume3.prototype.rmSync = function(path, options) {
        this.rmBase(pathToFilename(path), options);
      };
      Volume3.prototype.rm = function(path, a, b) {
        var _a2 = getRmOptsAndCb(a, b), opts = _a2[0], callback = _a2[1];
        this.wrapAsync(this.rmBase, [pathToFilename(path), opts], callback);
      };
      Volume3.prototype.fchmodBase = function(fd, modeNum) {
        var file = this.getFileByFdOrThrow(fd, "fchmod");
        file.chmod(modeNum);
      };
      Volume3.prototype.fchmodSync = function(fd, mode) {
        this.fchmodBase(fd, modeToNumber(mode));
      };
      Volume3.prototype.fchmod = function(fd, mode, callback) {
      ...
      Volume3.prototype.chmodSync = function(path, mode) {
        var modeNum = modeToNumber(mode);
        var filename = pathToFilename(path);
        this.chmodBase(filename, modeNum);
      };
      Volume3.prototype.chmod = function(path, mode, callback) {
        var modeNum = modeToNumber(mode);
        var filename = pathToFilename(path);
      ...
      Volume3.prototype.lchmodSync = function(path, mode) {
        var modeNum = modeToNumber(mode);
        var filename = pathToFilename(path);
        this.lchmodBase(filename, modeNum);
      };
      Volume3.prototype.lchmod = function(path, mode, callback) {
        var modeNum = modeToNumber(mode);
        var filename = pathToFilename(path);
        this.wrapAsync(this.lchmodBase, [filename, modeNum], callback);
      };
      Volume3.prototype.fchownBase = function(fd, uid, gid) {
        this.getFileByFdOrThrow(fd, "fchown").chown(uid, gid);
      };
      Volume3.prototype.fchownSync = function(fd, uid, gid) {
        validateUid(uid);
        validateGid(gid);
        this.fchownBase(fd, uid, gid);
      };
      Volume3.prototype.fchown = function(fd, uid, gid, callback) {
        validateUid(uid);
        validateGid(gid);
      ...
      Volume3.prototype.chownSync = function(path, uid, gid) {
        validateUid(uid);
        validateGid(gid);
        this.chownBase(pathToFilename(path), uid, gid);
      };
      Volume3.prototype.chown = function(path, uid, gid, callback) {
        validateUid(uid);
        validateGid(gid);
      ...
      Volume3.prototype.lchownSync = function(path, uid, gid) {
        validateUid(uid);
        validateGid(gid);
        this.lchownBase(pathToFilename(path), uid, gid);
      };
      Volume3.prototype.lchown = function(path, uid, gid, callback) {
        validateUid(uid);
        validateGid(gid);
        this.wrapAsync(this.lchownBase, [pathToFilename(path), uid, gid], callback);
      };
      Volume3.prototype.watchFile = function(path, a, b) {
        var filename = pathToFilename(path);
        var options = a;
        var listener = b;
      ...
      Volume3.prototype.unwatchFile = function(path, listener) {
        var filename = pathToFilename(path);
        var watcher = this.statWatchers[filename];
        if (!watcher)
          return;
      ...
      Volume3.prototype.createReadStream = function(path, options) {
        return new this.ReadStream(path, options);
      };
      Volume3.prototype.createWriteStream = function(path, options) {
        return new this.WriteStream(path, options);
      };
      Volume3.prototype.watch = function(path, options, listener) {
        var filename = pathToFilename(path);
...
var require_lib = __commonJS({
  "../../node_modules/memfs/lib/index.js"(exports, module2) {
    "use strict";
...
// src/NativeScriptPreviewWebpackPlugin.ts
...
// src/ipc/webpackIPC.ts
function getWebpackMessage(type, data) {
  return {
    type,
    data
  };
...
var NativeScriptPreviewWebpackPlugin = class {
  constructor(options, fs = (0, import_memfs.createFsFromVolume)(new import_memfs.Volume())) {
    this.options = options;
    this.fs = fs;
  }
  apply(compiler) {
    this.outPath = compiler.options.output.path;
    compiler.outputFileSystem = this.fs;
    this.attachStatusListeners(compiler, ["beforeCompile", "done"]);
    ...
    process.on("message", (message) => {
      ...
      switch (message.type) {
        case "webpack::get_latest_files" /* GET_LATEST_FILES */:
          {
            const msg = message;
            const assets = currentCompilation == null ? void 0 : currentCompilation.getAssets();
            const hash = currentCompilation == null ? void 0 : currentCompilation.hash;
            if (!assets || !hash) {
              return;
            }
            const files = assets.map((asset) => {
              return this.getIPCFile(asset.name);
            });
            const response = getWebpackMessage(
              "webpack::files" /* FILES */,
              {
                mid: msg.data.mid,
                hash,
    ...
    tapProcessSend((message) => {
      var _a;
      if ((message == null ? void 0 : message.type) !== "compilation") {
        return;
      }
      const files = message.data.emittedAssets.map(
        (asset) => {
          return this.getIPCFile(asset);
        }
      );
      const response = getWebpackMessage(
        "webpack::files" /* FILES */,
        {
          ...
          platform: this.options.platform,
          files,
          staleFiles: (_a = message.data.staleAssets) != null ? _a : []
        }
      );
      if (response.data.files.length || response.data.staleFiles.length) {
        process.send(response);
      }
    });
  }
  attachStatusListeners(compiler, states) {
    states.forEach((state) => {
      compiler.hooks[state].tap(this.constructor.name, () => {
        process.send(
          getWebpackMessage("webpack::state" /* STATE */, {
            state
          })
        );
      });
  ...
  getIPCFile(path) {
    const type = (0, import_mime_types.lookup)((0, import_node_path.extname)(path));
    const { size } = this.fs.statSync((0, import_node_path.join)(this.outPath, path));
    const contents = this.fs.readFileSync(`${this.outPath}/${path}`);
    return {
      path,
      type,
      size,
